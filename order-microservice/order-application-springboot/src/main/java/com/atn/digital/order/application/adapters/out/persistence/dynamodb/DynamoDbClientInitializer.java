package com.atn.digital.order.application.adapters.out.persistence.dynamodb;

import com.atn.digital.order.application.adapters.config.dynamodb.DynamoDbConfig;
...
public class DynamoDbClientInitializer implements DisposableBean {
    ...
    private void initialize() {
        System.setProperty("ORDER_TABLE", config.tableName());

        client = DynamoDbClient.builder().endpointOverride(URI.create(config.uri())).build();
        String tableName = System.getProperty("ORDER_TABLE");
