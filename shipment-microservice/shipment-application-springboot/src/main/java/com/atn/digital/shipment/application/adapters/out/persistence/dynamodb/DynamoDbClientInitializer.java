package com.atn.digital.shipment.application.adapters.out.persistence.dynamodb;

import com.atn.digital.shipment.application.adapters.config.dynamodb.DynamoDbConfig;
...
public class DynamoDbClientInitializer implements DisposableBean {
    ...
    private void initialize() {
        System.setProperty("SHIPMENT_TABLE", config.tableName());

        client = DynamoDbClient.builder().endpointOverride(URI.create(config.uri())).build();
        String tableName = System.getProperty("SHIPMENT_TABLE");
