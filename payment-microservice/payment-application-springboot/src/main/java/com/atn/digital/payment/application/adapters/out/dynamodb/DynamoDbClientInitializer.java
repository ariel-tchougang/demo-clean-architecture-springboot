package com.atn.digital.payment.application.adapters.out.dynamodb;

import com.atn.digital.payment.application.adapters.config.dynamodb.DynamoDbConfig;
...
public class DynamoDbClientInitializer implements DisposableBean {
    ...
    private void initialize() {
        System.setProperty("PAYMENT_TABLE", config.tableName());

        client = DynamoDbClient.builder().endpointOverride(URI.create(config.uri())).build();
        String tableName = System.getProperty("PAYMENT_TABLE");
